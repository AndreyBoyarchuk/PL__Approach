...
// Add separator row to statement element
    ...
    statement.insertAdjacentHTML("beforeend", `<tr class="subtotal"><th class="total-header">Total Operating Expenses</th><td class="text-end">${totalExpenses.toLocaleString()}</td></tr>`);
